      ...
      <div class="mui-scroll"> -->
        ...
        <div class="regmain" v-show="cflag">            
            ...
            <div class="reginput" v-show='!lflag' >
                <img class="headimg" ref="himg" @click="chooseimg" src="http://songshu.xiaomy.net/headimg/null.jpg">
...
export default {
    ...
    methods: {
        async login(){
             ...
             let {data}= await myaxios('POST','http://47.103.222.56:8899/api/login',obj)
      ...
      this.$router.go(-1);
        ...
        async chooseimg(){
            ...
            this.cflag = false;
            this.iflag = true;
            let {data} = await myaxios("GET",'http://47.103.222.56:8899/api/getheadimg')            
            if(data.status == 0){
        ...
        async postmsg(){
            ...
            let {data} = await myaxios("POST",'http://47.103.222.56:8899/api/register',obj)
            if(data.status==0){
